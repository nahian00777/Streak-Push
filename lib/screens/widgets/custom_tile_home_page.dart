...
class CustomTileHomePage extends StatelessWidget {
  ...
  const CustomTileHomePage({super.key, required this.onnClick});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onLongPress: () {
        ...
        animeController.tileColor.value = animeController.isPressed.value ? primaryColor2 : Colors.white;
      },
      child: Obx(() {
        // Use AnimatedContainer for smooth color transitions
        return AnimatedContainer(
          duration: Duration(milliseconds: 300), // Duration for color transition
